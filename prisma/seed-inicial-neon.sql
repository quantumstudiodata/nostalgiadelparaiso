...
INSERT INTO "Category" (id, name, slug, "order", "cardTitle", description, "imageUrl")
VALUES
  ('b4b213b3-a2f3-48a7-8339-b6875869b2b2', 'Blog de Ángeles Nava', 'blog-angeles-nava', 0, 'Blog Ángeles Nava', NULL, '/images/angeles-nava.jpeg'),
  ('366afbe6-91cd-4def-95a8-1a5781af679c', 'Nostalgia del paraíso', 'nostalgia-del-paraiso', 1, 'Textos del Taller: Nostalgia del paraíso', 'Este espacio nace con el deseo de difundir la cultura de paz y dar voz a los alumnos del taller de poesía "Nostalgia del Paraíso". Aquí encontrarás un maravilloso universo de letras poéticas y más. Esta es tu casa virtual. La palabra es mía, tuya y de todos.', '/images/categoria-nostalgia-del-paraiso.png'),
  ('49c9109c-34a9-4792-99b8-11e9232f748e', 'Olas de Pleamar', 'olas-de-pleamar', 2, 'Textos del Taller Olas de pleamar', NULL, '/images/categoria-olas-de-pleamar.png'),
